...
<body>
    ...
    <div class="container py-5">
        <div class="row py-5">
            <form action="edit.php" class="col-md-9 m-auto" method="post" role="form">
                <div class="row">
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputname" style="font-family: 'Times New Roman', Times, serif;">NOMBRE:</label>
                        <input type="text" class="form-control mt-1" id="name" name="name" value="<?php echo $mostrar['1']?>">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputemail" style="font-family: 'Times New Roman', Times, serif;">CORREO ELECTRÓNICO:</label>
                        <input type="text" class="form-control mt-1" id="email" name="email" value="<?php echo $mostrar['2']?>">
                    </div>
                    <div class="form-group mb-3">
                        <label for="inputphone" style="font-family: 'Times New Roman', Times, serif;">TELÉFONO:</label>
                        <input type="text" class="form-control mt-1" id="email" name="phone" value="<?php echo $mostrar['3']?>">
                    </div>
                </div>
                <div class="mb-3">
                    <label for="inputsubject" style="font-family: 'Times New Roman', Times, serif;">ASUNTO:</label>
                    <input type="text" class="form-control mt-1" id="subject" name="subject" value="<?php echo $mostrar['4']?>">
                </div>
                <div class="mb-3">
                    <label for="inputmessage" style="font-family: 'Times New Roman', Times, serif;">MENSAJE:</label>
                    <textarea class="form-control mt-1" id="message" name="message" value="<?php echo $mostrar['5']?>" rows="8"></textarea>
                </div>
                <div class="row">
                    <div class="col text-end mt-2">
                        <a href="read.php" class="btn btn-success btn-lg px-3" style="background-color:#69bb7e; padding: 10px 20px; border-radius: 4px; border-color:black; color: white; cursor: pointer; font-family: 'Times New Roman', Times, serif; width: 25%;"><b>CANCELAR</b></a>
                        <button type="submit" nameclass="btn btn-success btn-lg px-3" style="background-color:#69bb7e; padding: 10px 20px; border-radius: 4px; border-color: black; color: white; cursor: pointer; font-family: 'Times New Roman', Times, serif; width: 25%;"><b>ENVIAR</b></button>
                    </div>
                </div>
                <?php
                }
